...
GTO.init = function () {
	...
	COR.divBrowseModels.innerHTML += GTO.getMenu()
...
<details>
	...
	<summary title="gto-generate-threejs-objects-02.js" >Generate Three.js objects</summary>
	...
	<p><button onclick=addMeshes(); >add meshes</button></p>
...
GTO.onGenerateObject = function () {
	...
	VC.zoomObjectBoundingSphere(mesh);
