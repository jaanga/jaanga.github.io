...
`
<details open>
	<summary>GTL Generate Three.js Lines</summary>
...
GTL.updateColorRandom = function () {
	...
	lines.children.forEach(line => line.material.color.set(0xffffff * Math.random()))
...
GTL.getNormal = function() {
	...
	const points = lines.children[0].geometry.vertices;
...
GTL.reverseNormal = function() {
	...
	//const geometry = lines.children[0].geometry;

	const points = lines.children[0].geometry.vertices.reverse();
