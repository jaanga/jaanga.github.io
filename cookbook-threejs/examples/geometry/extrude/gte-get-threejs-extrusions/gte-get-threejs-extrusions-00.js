...
GTE.getMenu = function () {
	...
	const htm =
		`
<details id=detGTE open>

	<summary>Get Three.js Extrusions</summary>
...
GTE.getMenuSettings = function () {
	...
	const htm =
		`
<details id=detGTEsettings open>

	<summary>Three.js extrusions settings</summary>
...
GTE.reset = function () {
	...
	scene.remove(GTE.extrusions);

	GTE.extrusions = new THREE.Group();

	scene.add(GTE.extrusions);
...
GTE.addMalteseCross = function () {
	...
	const v = (x, y, z) => new THREE.Vector3(x, y, z);
	const height = 50, width = 50; tailIn = 7; tailOut = 2;cheek = 30;
	vertices = [
		v(0, height - cheek, 0),
