...
<details ontoggle=OVD.getFilesObj();OVD.getScript();>
	...
	<div id=divMessage >Select an OBJ file to open from an automatically generated list of OBJ files from
...
-->
	...
	<div id=OVDdivXhr ></div>

	<div id=OVDdivMessage ></div>
...
OVD.getScript = function () {
	...
	if (!OVD.objLoader) {
		...
		OVD.objLoader.src = "https://cdn.jsdelivr.net/gh/mrdoob/three.js@r112/examples/js/loaders/OBJLoader.js";
...
`;
		...
		function (xhr) {
			...
			OVDdivXhr.innerHTML = `<p>${xhr.loaded.toLocaleString()} loaded</p>`;
		...
		function (error) {
			...
			OVDdivXhr.innerHTML = `<p>An error happened: ${error}</p>`;
