...
GCO.drawIntersectionPoints = function () {
	...
	segmentVertices = GCO.getContours(GCO.pointsOfIntersection.vertices, [], true);
	//console.log('segmentVertices', segmentVertices );

	firstFirstPoint = GCO.pointsOfIntersection.vertices[0]
	...
	segmentVertices.forEach((vertices, index) => {
		...
		if (index === 0) { vertices.unshift(firstFirstPoint); }
