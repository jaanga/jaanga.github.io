...
GCO.getMenu = function () {
	...
	<details open>
		...
		<p>Adjust contour line parameters. Generate vertices. Draw points.</p>
		...
		<p>
			<button title="pressMe" onclick=GCO.getVerticesIsolines(); ><b>get multiple contours</b></button>
...
GCO.reset = function () {
	...
	GCOdivMessage.innerHTML = "Statistics will appear here";
...
Plane elevation: ${ meshPlane.position.z.toLocaleString()}<br>
