...
<details open>
	...
	<p>
		<button id="pressMe" onclick=GCO.limit=1;GCO.constant=0;GCO.getContourPoints(); ><b>get single contour</b></button>
	</p>
</details>
`;
...
GCO.getPoints = function (constant = 0) {
	...
	const plane = new THREE.Plane( normal, GCO.constant + 1 )
