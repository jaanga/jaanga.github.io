...
DLF.scripts = [
	...
	"https://cdn.jsdelivr.net/gh/mrdoob/three.js@r112/examples/js/lines/LineSegmentsGeometry.js",
	"https://cdn.jsdelivr.net/gh/mrdoob/three.js@r112/examples/js/lines/LineGeometry.js",
	"https://cdn.jsdelivr.net/gh/mrdoob/three.js@r112/examples/js/lines/LineMaterial.js",
	"https://cdn.jsdelivr.net/gh/mrdoob/three.js@r112/examples/js/lines/LineSegments2.js",
	"https://cdn.jsdelivr.net/gh/mrdoob/three.js@r112/examples/js/lines/Line2.js"
...
<details ontoggle=DLF.getScripts(); >
	...
	<summary>Draw fat lines</summary>
	...
	<p title="line width: 1 to 20" >
		line width <output id=DLFoutLineWidth class=floatRight >3</output><br>
		<input type="range" id="DLFrngLineWidth" min=1 max=5 step=0.05 value=3 oninput=DLF.renderLinesFat(CFR.contours); >
	</p>

	<p>
		<button onclick=DLF.applyColorRandom() title="could be a gradient of colors" >apply color random</button>
	</p>
